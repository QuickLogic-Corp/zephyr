...
The driver is interfaced with the :ref:`Clock Control API <clock_control_api>` function:

.. doxygenfunction:: clock_control_on
   :project: Zephyr
...
Clock output status (frequency, duty and phase offset) can be acquired with function:

.. doxygenfunction:: clock_control_get_status
   :project: Zephyr

Clock output frequency can be queried with function:

.. doxygenfunction:: clock_control_get_rate
   :project: Zephyr
