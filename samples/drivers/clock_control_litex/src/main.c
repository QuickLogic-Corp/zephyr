...
int litex_clk_test_getters(struct device *dev)
{
...
int litex_clk_test_single(struct device *dev)
{
...
int litex_clk_test_freq(struct device *dev)
{
	struct litex_clk_setup setup = {
		.clkout_nr = LITEX_CLK_TEST_CLK1,
...
int litex_clk_test_phase(struct device *dev)
{
	struct litex_clk_setup setup1 = {
		.clkout_nr = LITEX_CLK_TEST_CLK1,
...
int litex_clk_test_duty(struct device *dev)
{
	struct litex_clk_setup setup1 = {
		.clkout_nr = LITEX_CLK_TEST_CLK1,
...
int litex_clk_test(struct device *dev)
{
	int ret;
